...
DATA_LOC = 'E:\compcars\sv_data_38classes\image'
DATA_NAMES = 'full'
...
from utils_network import originalPCAPaper_RGB
model = originalPCAPaper_RGB(num_classes=NUM_CLASSES)           # this will need to be changed based the dataset I guess
