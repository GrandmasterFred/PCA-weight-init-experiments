...
from utils_network import originalPCAPaper, custom_1conv, custom_4conv, custom_6conv, custom_8conv
model = custom_8conv(num_classes=NUM_CLASSES)           # this will need to be changed based the dataset I guess
...
conv_layers_with_required_fmaps = [
    ...
    (model.features4[0], model.features3),
    (model.features5[0], model.features4),
    (model.features6[0], model.features5),
    (model.features7[0], model.features6),
    (model.features8[0], model.features7)
]
...
# targeting the conv block, which is the first of the features 
current_feature = conv_layers_with_required_fmaps[3][0]
current_fmap = feature_map      # this could have been [0][1] but since it is none, it should be targeted at the original feature map, which is just the sample PCA images 
...
# targeting the conv block, which is the first of the features 
current_feature = conv_layers_with_required_fmaps[4][0]
current_fmap = feature_map      # this could have been [0][1] but since it is none, it should be targeted at the original feature map, which is just the sample PCA images 
...
# targeting the conv block, which is the first of the features 
current_feature = conv_layers_with_required_fmaps[5][0]
current_fmap = feature_map      # this could have been [0][1] but since it is none, it should be targeted at the original feature map, which is just the sample PCA images 
...
# targeting the conv block, which is the first of the features 
current_feature = conv_layers_with_required_fmaps[6][0]
current_fmap = feature_map      # this could have been [0][1] but since it is none, it should be targeted at the original feature map, which is just the sample PCA images 
...
# targeting the conv block, which is the first of the features 
current_feature = conv_layers_with_required_fmaps[7][0]
current_fmap = feature_map      # this could have been [0][1] but since it is none, it should be targeted at the original feature map, which is just the sample PCA images 
